...
|---|---|---|
| **1. Staging** | [`sql/01_staging.sql`](sql/01_staging.sql) | Raw source CSVs loaded from **Azure Blob Storage** into Snowflake staging tables — no transformation (the "load" in ELT). |
